...
#include <cmath>
    ...
    */
    ...
    double calculateDistance(int* vec1, int* vec2){
    ...
    */
    void updateIndicies(int* car_information){
        ...
        cout << "Car Projection Vector: " << "[" << car_projection[0] << ","
                << car_projection[1] << "]" << '\n';
        
        double res;
        res = calculateDistance(&track_vector[0], &car_vector[0]);
        
        cout << "Distance from car to track: " << res << '\n';
